...
import { TeamMemberModel, type TeamMemberDocument } from './modules/content/models/team.model.js';
...
const EVENTS: Array<Partial<EventDocument>> = [
  {
    ...
    questions: [
      {
        id: 'stage',
        label: 'Which stage best describes where you are right now?',
        type: 'single-choice',
        options: ['Exploring my career options', 'Studying', 'Looking for my first job', 'Looking for a better job', 'Building my career', 'Starting a business', 'Scaling an existing business', 'Looking for funding/investment', 'Looking for scholarships/fellowships', 'Building skills for the future', 'Leading a youth/women-focused initiative', 'Other'],
        required: false,
      },
      {
        id: 'challenges',
        label: 'What are the biggest challenges you face right now?',
        type: 'multi-choice',
        options: ['Finding employment', 'Building relevant skills', 'Using AI effectively', 'Building my CV/portfolio', 'Passing interviews', 'Finding clients', 'Growing my business', 'Accessing funding', 'Finding investors', 'Building professional networks', 'Finding scholarships', 'Finding fellowships/global opportunities', 'Lack of mentorship', 'Lack of confidence', 'Lack of access to opportunities', 'Balancing career and personal responsibilities', 'Other'],
        required: false,
        helpText: 'Pick up to three.',
      },
      {
        id: 'ai-knowledge',
        label: 'How would you rate your current knowledge of AI?',
        type: 'single-choice',
        options: ['Beginner — I know very little', 'Basic — I understand the fundamentals', 'Intermediate — I use AI occasionally', 'Advanced — I use AI regularly', 'Expert — I work professionally with AI'],
        required: false,
      },
      {
        id: 'ai-usage',
        ...
        type: 'multi-choice',
        options: ['I don\'t currently use AI', 'Research/learning', 'Writing/content creation', 'CV/job applications', 'Business development', 'Marketing', 'Data analysis', 'Coding/technology', 'Productivity', 'Education', 'Creative work', 'Other'],
        required: false,
      },
      {
        id: 'ai-learn',
        label: 'What would you most like to learn about AI?',
        type: 'single-choice',
        options: ['AI tools for career growth', 'AI for job searching', 'AI for productivity', 'AI for business', 'AI for entrepreneurship', 'AI for content creation', 'AI for education', 'AI and future jobs', 'AI ethics', 'Building AI-powered businesses', 'Other'],
        required: false,
      },
      {
        id: 'your-question',
        label: 'What one question would you like answered during the session?',
        type: 'long-text',
        options: [],
        required: false,
      },
      {
        id: 'community',
        label: 'Would you like updates about future programmes and opportunities?',
        type: 'single-choice',
        options: ['Yes', 'No'],
        required: false,
      },
      {
        ...
        type: 'single-choice',
        options: ['LinkedIn', 'Instagram', 'WhatsApp', 'Facebook', 'X', 'Friend/colleague', 'School/university', 'Organization/community', 'Email', 'Other'],
        required: false,
      },
    ],
  },
  {
    ...
    startAt: new Date('2026-10-02T17:00:00.000Z'),
    location: 'Online',
    type: 'webinar',
    status: 'published',
    ...
    questions: [
      ...
      {
        id: 'has-business',
        label: 'Are you currently running a business?',
        type: 'single-choice',
        options: ['Yes', 'No', 'I am planning to start one', 'I have an idea but haven\'t started', 'I previously ran a business'],
        required: false,
      },
      {
        id: 'business-stage',
        ...
        type: 'single-choice',
        options: ['Idea stage', 'Pre-revenue', 'Early revenue', 'Growing', 'Scaling', 'Established'],
        required: false,
      },
      {
        ...
        type: 'single-choice',
        options: ['Funding', 'Customers', 'Marketing', 'Sales', 'Technology', 'Team', 'Operations', 'Business strategy', 'Investor readiness', 'Networking', 'Expansion into new markets', 'Other'],
        required: false,
      },
      {
        id: 'investment-learn',
        label: 'What would you most like to learn about raising investment?',
        type: 'single-choice',
        options: ['Finding investors', 'Preparing a pitch deck', 'Understanding what investors want', 'Valuation', 'Business model', 'Financial projections', 'Building traction', 'Due diligence', 'Grants vs investment', 'Scaling across West Africa'],
        required: false,
      },
      {
        id: 'your-question',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'job-seeking',
        label: 'Are you currently looking for employment?',
        type: 'single-choice',
        options: ['Yes, actively', 'Yes, but not urgently', 'No, but open to opportunities', 'No'],
        required: false,
      },
      {
        id: 'job-type',
        ...
        type: 'single-choice',
        options: ['Internship', 'Graduate/entry-level job', 'Mid-level job', 'Senior-level position', 'Remote job', 'Freelance opportunity', 'Contract work', 'Apprenticeship', 'Volunteer opportunity'],
        required: false,
      },
      {
        id: 'job-challenge',
        label: 'What is your biggest challenge in getting a job?',
        type: 'single-choice',
        options: ['Finding opportunities', 'CV/resume', 'LinkedIn profile', 'Personal branding', 'Networking', 'Interviews', 'Lack of experience', 'Lack of skills', 'Knowing where to apply', 'Confidence', 'Other'],
        required: false,
      },
      {
        id: 'ready-meaning',
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'opp-types',
        label: 'Which opportunities are you interested in?',
        type: 'multi-choice',
        options: ['Scholarships', 'Fellowships', 'Internships', 'Grants', 'Youth programs', 'Leadership programs', 'Conferences', 'Exchange programs', 'Research opportunities', 'Entrepreneurship programs', 'International jobs', 'Volunteering', 'Mentorship programs'],
        required: false,
      },
      {
        id: 'opp-challenge',
        label: 'What is your biggest challenge accessing global opportunities?',
        type: 'single-choice',
        options: ['I don\'t know where to find them', 'I find them but struggle to qualify', 'The application process is difficult', 'Writing applications/personal statements', 'Lack of funding', 'Lack of information', 'Lack of mentorship', 'Lack of confidence', 'Other'],
        required: false,
      },
      {
        id: 'opp-wanted',
        label: 'What type of opportunity would you most like us to share with you?',
        type: 'short-text',
        options: [],
        required: false,
      },
...
const TEAM: Array<Partial<TeamMemberDocument>> = [
  {
    name: 'Emmanuel Mbansi',
    role: 'President',
    tier: 'executive',
    bio: 'I build businesses that build people, and ecosystems that build nations. For over ten years across Africa and the UAE, I\'ve founded companies, led youth movements, and advised institutions on what the future of Africa requires.\n\nImpact by the numbers: more than 7,000 young leaders mentored through programmes and fellowships across Africa, and over $1M raised to support STEM education, women empowerment, and real estate initiatives.\n\nFounder & CEO of De-Future Solutions, an advertising agency helping brands tell stories that move markets. Founder of Impact Africa Alliance, driving enterprise, leadership, and opportunity across the continent. A portfolio spanning clothing, car rental, Airbnb, real estate, and laundry services operating in Accra, Lagos, and Dubai.\n\nHost of People Who Inspire, a global YouTube series spotlighting leaders who turn vision into action. President of the ALIWA Youth Leadership Program Network, leading a community of young African leaders. Advisor to AU and UN Youth, shaping policy and programmes for Africa’s next generation, and a conference speaker on entrepreneurship, leadership, and Africa’s future.\n\nMy work connects the diaspora to Africa, and connects young Africans to their potential. I believe faith, consistency, and service are how we turn detours into destiny.\n\nOff the clock: golf, books by the lake or beach, and pouring into young leaders.',
    linkedInUrl: 'https://www.linkedin.com/in/emmanuel-mbansi',
    instagramUrl: 'https://www.instagram.com/emmanuelmbansi',
    order: 1,
    isActive: true,
  },
  {
  ...
  },
  {
    ...
    linkedInUrl: 'https://www.linkedin.com/in/jemimah-opata1',
    instagramUrl: 'https://www.instagram.com/gem_jemey',
    order: 3,
    isActive: true,
  },
  {
    ...
    tier: 'executive',
    bio: 'Stanley Asoku Hayford (stanleyhayford.com) is a Senior Software Engineer and technology entrepreneur with over eight years of experience designing and building scalable digital products and distributed systems.\n\nHe holds a BSc in Computer Engineering from KNUST. His professional experience spans high-throughput event-driven systems, enterprise software, SaaS platforms, and consumer-facing digital products.\n\nStanley works as a Software Engineer at XCreativs (xcreativs.com), where he is Co-Founder and CTO, and is Founder of Neurodyne Corp (neurodyne.dev). He contributes to large-scale systems built with Go, microservices, event-driven architectures, cloud infrastructure, and modern DevOps practices. His broader technical expertise includes Next.js, TypeScript, Python, SQL and NoSQL databases, Kafka, RabbitMQ, Docker, Kubernetes, and cloud-native architecture.\n\nBeyond engineering, Stanley has led product development from concept and requirements through architecture, implementation, deployment, and ongoing operations. He is particularly interested in using technology to solve practical African problems, and in building scalable platforms that grow from local solutions into sustainable businesses.\n\nHe combines hands-on engineering expertise with product thinking, system architecture, technical leadership, and a strong understanding of how technology translates into measurable business value.\n\nAt Impact Africa Alliance he leads the technical work: the public website, the admin platform behind it, and the systems that keep programme data reliable.',
    websiteUrl: 'https://stanleyhayford.com',
    linkedInUrl: 'https://www.linkedin.com/in/stanley-asoku-hayford',
    githubUrl: 'https://github.com/stanleyHayes',
    xUrl: 'https://x.com/sa_hayford',
    instagramUrl: 'https://instagram.com/hayford.stanley',
    order: 4,
    isActive: true,
  },
  {
  ...
  },
  {
    ...
    bio: 'Testimony Tewogbola — The Brand Nurse. A Registered Nurse, Brand Designer, Creative Strategist and community builder using creativity, communication and digital skills to create meaningful impact.\n\nHe holds a Bachelor of Nursing Science and is a registered nurse with a strong interest in healthcare, leadership, innovation and human development. Nursing introduced him to service, empathy and people-centred impact; his creative work lets him serve another way, helping individuals, businesses and communities communicate their value.\n\nAs a Brand Designer and Creative Strategist he works with entrepreneurs, CEOs and growing brands on visual identity, social media design, visual communication, content strategy and creative direction, for Nigerian and international clients.\n\nHe is Director of Creative Nurses Community, equipping nurses and other healthcare professionals with creative and digital skills that expand their influence beyond clinical practice. At Impact Africa Alliance he brings that branding and digital creativity to the organisation\'s mission, believing Africa\'s transformation needs people willing to use their skills intentionally to solve problems and tell better stories.',
    tier: 'executive',
    order: 8,
    isActive: true,
  },
