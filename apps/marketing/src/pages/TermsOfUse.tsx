    ...
    <Container sx={{ py: { xs: 6, md: 8 } }}>
      <Stack spacing={1}>
        ...
        <Section title="1. Use of the website">
          <Body>
            You may use this website for lawful purposes only. You agree not to use the site in any
            way that could damage, disable, overburden, or impair our servers or networks, or
        ...
        <Section title="2. Intellectual property">
          <Body>
            ...
            the property of Impact Africa Alliance or its licensors and is protected by copyright
        ...
        <Section title="3. User submissions">
          <Body>
            ...
            channels, you grant us permission to use that information to respond to your request and
        ...
        <Section title="5. Disclaimer">
          <Body>
            The information on this website is provided &quot;as is&quot; without warranties of any kind. We
            make every effort to ensure accuracy, but we do not guarantee that the content is
        ...
        <Section title="6. Limitation of liability">
          <Body>
            To the fullest extent permitted by law, Impact Africa Alliance shall not be liable for
            any direct, indirect, incidental, or consequential damages arising from your use of this
            website.
          </Body>
        </Section>
        ...
        <Section title="7. Changes to these terms">
          <Body>
            We may update these Terms of Use from time to time. Continued use of the website after
        ...
        <Section title="8. Governing law">
          <Body>
            These Terms of Use are governed by the laws of the Republic of Ghana. Any dispute arising
            from your use of this website shall be subject to the exclusive jurisdiction of the courts
            of Ghana.
          </Body>
        </Section>
