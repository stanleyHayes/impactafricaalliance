    ...
    <Container sx={{ py: { xs: 6, md: 8 } }}>
      ...
      <Stack spacing={1}>
        <Body>
          ...
          how visitors use it, and improve the experience. This policy explains what we use and how
          you can control it.
        </Body>
        ...
        <Section title="2. Essential cookies">
          <Body>
            Some cookies are necessary for the website to function. These include security features
            and basic navigation. Essential cookies cannot be turned off without breaking core
            functionality.
          </Body>
        </Section>
        ...
        <Section title="3. Analytics cookies">
          <Body>
            We use Google Analytics to understand how visitors find and move through our site. This
            data is aggregated and helps us improve content and navigation. We only load analytics
            cookies after you accept them through the cookie banner.
          </Body>
        </Section>

        <Section title="4. Managing your preferences">
          <Body>
            When you first visit the site, you can choose to accept analytics cookies or use only
            essential cookies. You can also clear cookies through your browser settings at any time.
          </Body>
        </Section>

        <Section title="5. Changes to this policy">
          <Body>
            We may update this Cookie Policy as our website or the law changes. The latest version
