...
const PrivacyPolicy = (): JSX.Element => {
  const copy = usePageCopy('privacy-policy', {
    ...
    seoDescription:
      'Read the Impact Africa Alliance privacy policy to understand how we collect, use, and protect your personal information.',
        ...
        {copy.bodyContent ? (
          ...
          <Stack spacing={1}>
            <Body>
              ...
              the rights you have under the Ghana Data Protection Act 2012 (Act 843).
            </Body>
            ...
            <Section title="5. Cookies and analytics">
              <Body>
                We use essential cookies and optional analytics cookies. Analytics cookies are only
                loaded after you provide consent through our{' '}
            ...
            <Section title="6. Who we share data with">
              <Body>
                We do not sell personal data. We share it only with trusted service providers who
                help us operate the website, process payments (Stripe, Paystack), send emails, or
                analyse usage (Google Analytics). These providers are contractually required to
            ...
            <Section title="7. International transfers">
              <Body>
                Some service providers are based outside Ghana. Where data is transferred
                internationally, we rely on appropriate safeguards such as standard contractual
                clauses or providers certified under recognised privacy frameworks.
              </Body>
            </Section>
            ...
            <Section title="10. Security">
              <Body>
                We use encryption, access controls, regular backups, and secure development
                practices to protect personal data. Admin access to our systems requires strong
            ...
            <Section title="11. Children">
              <Body>
                Our website is not directed at children under 16. If we learn that we have collected
                data from a child without appropriate consent, we will delete it promptly.
              </Body>
            </Section>
            ...
            <Section title="12. Changes to this policy">
              <Body>
                ...
                available on this page, and we will update the &quot;Last updated&quot; date
                accordingly.
              </Body>
            </Section>
            ...
            <Section title="13. Contact us">
              <Body>
                ...
                contact us at <Link href={`mailto:${ORG.email}`}>{ORG.email}</Link> or through our{' '}
