 ...
 *
 * A site that has never been told which personal links to show falls back to
 ...
 */
const toTeamSocialsEnabledValues = (data: SiteSetting): Record<string, boolean> =>
  Object.fromEntries(
    TEAM_SOCIAL_FIELDS.map((field) => [field, isTeamSocialEnabled(data.teamSocialsEnabled, field)]),
  );
...
const toFormValues = (data: SiteSetting): SiteSettingUpdateInput => ({
  ...
  teamSocialsEnabled: toTeamSocialsEnabledValues(data),
});
